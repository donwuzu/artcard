            ...
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-9 mb-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9 2H15C16.1 2 17 2.9 17 4V5H18C19.1 5 20 5.9 20 7V20C20 21.1 19.1 22 18 22H6C4.9 22 4 21.1 4 20V7C4 5.9 4.9 5 6 5H7V4C7 2.9 7.9 2 9 2Z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    @foreach($portraits as $portrait)
        <div class="bg-white p-4 rounded-2xl shadow relative">
            ...
            <div class="mt-4 flex space-x-2">
                <button onclick="openEditModal({{ $portrait->id }}, {{ $portrait->price }})" 
                ...
                <form action="{{ route('portraits.destroy', $portrait->id) }}" method="POST" class="inline">
                    ...
                    <button type="submit" 
                            ...
                            onclick="return confirm('Are you sure you want to delete this portrait?')">
                        Delete
                    </button>
                </form>
            </div>
        ...
        <form id="editForm" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="editPrice" name="price" 
                       class="w-full px-3 py-2 border rounded" required min="0" step="0.01">
            </div>
...
<script>
    function openEditModal(id, price) {
        ...
        // Set form action and price value
