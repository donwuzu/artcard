...
<div id="cart-overlay" class="cart-overlay fixed inset-0 bg-black bg-opacity-50 hidden z-40">
  ...
  <div id="cartSidebar" 
       ...
       class="absolute right-0 top-0 w-full max-w-md bg-white flex flex-col h-dvh">

      <header class="flex-shrink-0 relative border-b border-slate-200 px-4 py-3 sm:px-5 sm:py-4">
          <h2 id="cart-heading" class="text-base sm:text-lg font-semibold text-slate-800 text-center">Your Selected Portraits</h2>
          <button id="closeCart" 
                  aria-label="Close cart"
                  class="absolute top-1/2 right-4 -translate-y-1/2 text-xl sm:text-2xl font-semibold text-slate-500 hover:text-red-600 transition-colors">
              &times;
          </button>
      </header>

      <div class="flex-grow overflow-y-auto px-3 sm:px-5 py-3">
          <table class="w-full text-xs sm:text-sm text-slate-600">
              <thead>
                  <tr class="border-b border-slate-200">
                      <th class="w-2/5 text-left font-medium pb-2 pl-1 sm:pb-3 sm:pl-2">Portrait</th>
                      <th class="w-1/6 text-center font-medium pb-2 sm:pb-3">Qty</th>
                      <th class="w-1/5 text-right font-medium pb-2 sm:pb-3">Price</th>
                      <th class="w-1/5 text-right font-medium pb-2 sm:pb-3">Subtotal</th>
                      <th class="w-auto text-right font-medium pb-2 pr-1 sm:pb-3 sm:pr-2"><span class="sr-only">Actions</span></th>
                  </tr>
              </thead>
              <tbody id="checkout-summary-body" class="divide-y divide-slate-100">
                   <tr>
                      <td colspan="5" class="text-center text-slate-500 py-8 sm:py-10">Your cart is currently empty.</td>
                  </tr>
              </tbody>
          </table>
      </div>

      <footer class="flex-shrink-0 bg-slate-50 px-3 sm:px-5 pt-3 pb-4 sm:pt-5 sm:pb-6 border-t border-slate-200">
          ...
          <div class="flex justify-between items-center font-semibold text-base sm:text-lg border-t border-slate-200 mt-3 pt-3 sm:mt-4 sm:pt-4">
              <span class="text-slate-800">Grand Total:</span>
              <span id="total" class="text-green-600">KSh 0</span>
          </div>

          <button type="button" id="orderButton"
                  class="w-full bg-green-600 hover:bg-green-700 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold text-sm sm:text-base shadow-sm hover:shadow-lg transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white mt-3 sm:mt-4">
              Order Via WhatsApp
          </button>
      </footer>
  </div>
