<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- Upload Form --}}
            <form method="POST"
                  action="{{ route('admin.sample-images.store') }}"
            ...
            {{-- Gallery --}}
            <h3 class="text-lg font-bold mt-6">Sample Images</h3>
            ...
            <script>
                function openEditModal(id, price) {
                    ...
                    document.getElementById('editForm').action = `/admin/sample-images/${id}`;
                }
